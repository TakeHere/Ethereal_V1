...
public class ParticleGenerator {
    ...
    public ParticleGenerator(Vector2 location, Dimension dimension, Image texture, boolean gravity, int amount, int minSpeed, int maxSpeed, long lifeTimeMs, Scene scene) {
