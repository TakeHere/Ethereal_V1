...
public class EtherealExample extends Game {
    ...
    public void init() {
        ...
        new Title("Bienvenue !", new Vector2(200, 50), Color.RED, "Bahnschrift", 50, 2000, this);
    }
    ...
    public void gameLoop(double deltaTime) {
        ...
        if (this.gameWindow.isPressed(KeyEvent.VK_E)){
            this.switchScene(new Scene() {
                @Override
                public void init() {
                    new Title("Deuxieme scene !", new Vector2(100, 50), Color.RED, "Bahnschrift", 50, 2000, this);
                }
